...
&& $_POST['pass'] === $array1[0]['pass1']){
		echo $array1[0]['user_name'].'('.$array1[0]['term'].')';
		echo '<br>';
		echo $array2[0]['task1'];
		echo '<br>';
		echo $array2[0]['task2'];
	...
	&& $_POST['pass'] === $array1[1]['pass1']){
		echo $array1[1]['user_name'].'('.$array1[1]['term'].')';
		echo '<br>';
		echo $array2[1]['task1'];
		echo '<br>';
		echo $array2[1]['task2'];
	...
	&& $_POST['pass'] === $array1[2]['pass1']){
		echo $array1[2]['user_name'].'('.$array1[2]['term'].')';
		echo '<br>';
		echo $array2[2]['task1'];
		echo '<br>';
		echo $array2[2]['task2'];
	...
	&& $_POST['pass'] === $array1[3]['pass1']){
		echo $array1[3]['user_name'].'('.$array1[3]['term'].')';
		echo '<br>';
		echo $array2[3]['task1'];
		echo '<br>';
		echo $array2[3]['task2'];
	...
	&& $_POST['pass'] === $array1[4]['pass1']){
		echo $array1[4]['user_name'].'('.$array1[4]['term'].')';
		echo '<br>';
		echo $array2[4]['task1'];
		echo '<br>';
		echo $array2[4]['task2'];
